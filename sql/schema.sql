-- Nifty 50 Dashboard — Full Schema DDL (Alembic baseline)
...
--
-- This file is the Alembic baseline (revision 0001_baseline) and is applied
-- verbatim by alembic/versions/0001_baseline_baseline_schema.py. Every
-- CREATE uses IF NOT EXISTS so re-applying it is safe.
--
-- After the baseline, ALL schema changes must go through Alembic:
--     alembic revision -m "describe change"
-- Do not edit this file or add new sql/migrations/*.sql — they will not be
-- applied by ``alembic upgrade head``. The historical sql/migrations/*.sql
-- files (004, 005, 006) are now absorbed into this schema and remain only
-- for archaeology.
